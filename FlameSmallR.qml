...
Item{
    ...
    width: 200
    height: 300
    transform: Scale { origin.y: 0; yScale: Math.abs(0.5*Math.sin(0.1*y)+0.8)}
    ...
    Canvas {
        ...
        property color fillStyle: 'yellow'
        ...
        onPaint: {
            ...
            ctx.beginPath();
            ctx.lineTo(124,0);
            ctx.quadraticCurveTo(117,25,112,150);
            ctx.quadraticCurveTo(107,25,100,0);
            ctx.stroke();
            ctx.restore();
            ctx.fill();
        }
